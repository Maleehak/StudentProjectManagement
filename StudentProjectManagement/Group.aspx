<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="StudentProjectManagement.Group" %>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                     ...
                     <td>
                        <asp:DropDownList ID="Projects" runat="server" Height="50px" Width="300px" >
                  ...
                  <tr>
                    ...
                    <td>
                        <asp:ListBox ID="Students" runat="server" Width="298px" SelectionMode="Multiple"></asp:ListBox>
                    </td>
